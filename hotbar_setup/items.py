items = {
  # "name":             ["Name",                      tab_location,    row, col]
    ...
    "electricFurnace":  ["Electric Furnace",          "production",     2, 3],
    ...
    "apAmmo":             ["Armor Piercing Ammo",     "combat",        1, 1],

    "grenade":            ["Grenade",                 "combat",        0, 3],

    "wall":               ["Wall",                    "combat",        0, 7],
    "gunTurret":          ["Gun Turret",              "combat",        2, 7],
    "laserTurret":        ["Laser Turret",            "combat",        3, 7],
    "flamethrowerTurret": ["Flamethrower",            "combat",        4, 7],
    "landMine":           ["Landmine",                "combat",        6, 0]
}
